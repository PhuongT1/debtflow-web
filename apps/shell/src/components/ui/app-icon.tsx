...
const paths: Record<AppIconName, string> = {
  ...
  close: "M18.3 5.71 12 12l6.3 6.29-1.41 1.41L10.59 13.41 4.29 19.71 2.88 18.3 9.17 12 2.88 5.71 4.29 4.29l6.3 6.3 6.3-6.3 1.41 1.42Z",
  ...
  delete: "M7 21q-.825 0-1.412-.587A1.93 1.93 0 0 1 5 19V7H4V5h5V4h6v1h5v2h-1v12q0 .825-.587 1.413A1.93 1.93 0 0 1 17 21H7Zm2-4h2V9H9v8Zm4 0h2V9h-2v8Z",
  ...
  visibility: "M12 5c-7 0-11 7-11 7s4 7 11 7 11-7 11-7-4-7-11-7Zm0 12c-4.44 0-7.54-3.57-8.73-5C4.46 10.57 7.56 7 12 7s7.54 3.57 8.73 5c-1.19 1.43-4.29 5-8.73 5Zm0-8a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z",
