...
export function CollectionForm({
  ...
  return (
    ...
    >
      <AppSelect label="Trạng thái thu tiền *" {...register("collectionStatus")} error={Boolean(errors.collectionStatus)} helperText={errors.collectionStatus?.message}>
      ...
      />
      <AppInput label="Ghi chú thu tiền" multiline rows={3} {...register("followUpNote")} error={Boolean(errors.followUpNote)} helperText={errors.followUpNote?.message} />
      <FormGrid>
        <AppInput label="Mã hóa đơn" {...register("invoiceNo")} error={Boolean(errors.invoiceNo)} helperText={errors.invoiceNo?.message} />
        <AppInput label="Mã đơn hàng" {...register("orderNo")} error={Boolean(errors.orderNo)} helperText={errors.orderNo?.message} />
        <AppInput label="Hợp đồng" {...register("contractNo")} error={Boolean(errors.contractNo)} helperText={errors.contractNo?.message} />
        <AppInput label="PO" {...register("poNo")} error={Boolean(errors.poNo)} helperText={errors.poNo?.message} />
      </FormGrid>
      <ApiErrorNotice error={mutation.error} />
      <FormActions><Button loading={mutation.isPending} type="submit">Cập nhật thu tiền</Button></FormActions>
    </Box>
  );
}
