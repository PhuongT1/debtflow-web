...
export function PartiesPageSkeleton() {
  const toolbar = (
    <>
      ...
      <Box sx={{ alignItems: "center", display: { xs: "none", md: "grid" }, gap: 1.5, gridTemplateColumns: "2fr repeat(4, minmax(140px, 1fr)) auto auto" }}>
        {Array.from({ length: 5 }, (_, index) => <AppSkeleton height={32} key={index} />)}
