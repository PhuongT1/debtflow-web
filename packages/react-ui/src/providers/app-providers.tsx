...
const theme = createTheme({
  ...
  components: {
      ...
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          "&.MuiButton-containedPrimary": {
            ...
            "&:hover": { backgroundColor: theme.palette.primary.dark, boxShadow: theme.shadows[6] },
          },
        ...
        outlined: ({ theme }) => ({
          ...
          "&:hover": { backgroundColor: theme.palette.action.hover, borderColor: theme.palette.primary.light },
        }),
        sizeSmall: {
          paddingLeft: 12,
          paddingRight: 12,
    ...
    MuiPickersOutlinedInput: {
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          borderRadius: 10,
          transition: "box-shadow 160ms ease, border-color 160ms ease",
          "& .MuiPickersOutlinedInput-notchedOutline": { borderColor: theme.palette.divider },
          "&:hover .MuiPickersOutlinedInput-notchedOutline": { borderColor: theme.palette.text.disabled },
          "&.Mui-focused": { boxShadow: `0 0 0 3px ${alpha(theme.palette.primary.main, 0.1)}` },
    ...
    MuiSelect: {
      styleOverrides: {
        icon: ({ theme }) => ({ color: theme.palette.text.secondary, right: 12 }),
      },
    },
    MuiTableCell: {
      styleOverrides: {
    ...
    MuiIconButton: {
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          "&:hover": { backgroundColor: alpha(theme.palette.primary.main, 0.09), color: theme.palette.primary.main },
        }),
      },
    },
    MuiMenu: {
    ...
    MuiMenuItem: {
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          margin: "2px 6px",
          minHeight: 40,
          "&.Mui-selected": { backgroundColor: theme.palette.action.selected, color: theme.palette.primary.dark },
          "&.Mui-selected:hover": { backgroundColor: alpha(theme.palette.primary.main, theme.palette.action.focusOpacity) },
        }),
      },
    },
    MuiChip: {
